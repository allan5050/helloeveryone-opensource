...
import { RefreshCw, Users, Network, BarChart3, Filter } from 'lucide-react'
...
export default function AnalyticsPage() {
  ...
  const filteredUsers = filterInterest === 'all'
    ? users
  ...
  const filteredScores = matchScores.filter(s => {
    ...
    return user1?.interests?.includes(filterInterest) || user2?.interests?.includes(filterInterest)
  })
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-medium">Avg Match Score</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold">
                {matchScores.length > 0
                  ? (matchScores.reduce((a, b) => a + b.score, 0) / matchScores.length).toFixed(2)
                  : '0.00'}
              </div>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-medium">Strong Matches</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-medium">Unique Interests</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                <label className="text-base font-medium mb-2 block">Interest Filter</label>
              ...
              <div>
                <label className="text-base font-medium mb-2 block">Selected User</label>
                <Select value={selectedUser || 'none'} onValueChange={v => setSelectedUser(v === 'none' ? null : v)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
        ...
        <Tabs defaultValue="network" className="space-y-4">
          <TabsList className="grid grid-cols-5 w-full max-w-lg text-base">
          ...
          <TabsContent value="network">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-3">Additional Dimensions</h3>
                  <DimensionGraphs
                    users={filteredUsers}
                    matchScores={filteredScores}
                    minScore={minScore}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-lg mb-3">Core Matching Algorithm</h3>
                  <div className="space-y-3 text-base">
                    <div className="font-mono bg-white p-3 rounded border">
                      ...
                      <div className="ml-4">f_i = similarity score for dimension i</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="border rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Interest Similarity (35%)</h4>
                    <p className="text-sm text-gray-600 mb-2">
                      Combines exact and fuzzy matching for robust interest alignment
                    </p>
                    <div className="space-y-1 text-xs font-mono">
                      <div>exact = Jaccard(interests_A, interests_B)</div>
                      <div>fuzzy = LevenshteinRatio(interests_A, interests_B)</div>
                      <div>score = 0.7 × exact + 0.3 × fuzzy</div>
                    </div>
                  </div>

                  <div className="border rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Semantic Similarity (25%)</h4>
                    <p className="text-sm text-gray-600 mb-2">
                  ...
                  <div className="border rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Age Compatibility (15%)</h4>
                    <p className="text-sm text-gray-600 mb-2">
                  ...
                  <div className="border rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Location Proximity (15%)</h4>
                    <p className="text-sm text-gray-600 mb-2">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-lg mb-3">Advanced Techniques</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-semibold text-sm mb-2">Diversity Factor (Future)</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-2">Interest Weighting (Future)</h4>
                      <p className="text-xs text-gray-600">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-lg mb-3">Performance & Scalability</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <div className="font-semibold">Computation Time</div>
                      <div className="text-gray-600">~2ms per pair</div>
                      <div className="text-xs text-gray-500">O(n²) complexity</div>
                    </div>
                    <div>
                      <div className="font-semibold">Database</div>
                      <div className="text-gray-600">pgvector for embeddings</div>
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-lg mb-3">Privacy & Ethical Considerations</h3>
                  <div className="space-y-3 text-sm">
                    <div>
                      <h4 className="font-semibold">Mutual Visibility</h4>
                      <p className="text-gray-600">
                        Users can only filter by attributes they themselves share, preventing discriminatory filtering.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold">Diversity Preservation</h4>
                      <p className="text-gray-600">
                        10% randomness factor prevents complete homophily, encouraging exposure to diverse perspectives.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold">Progressive Disclosure</h4>
                      <p className="text-gray-600">
                        Match strength shown as categories (Low/Medium/High) to end users, not exact percentages, reducing optimization gaming.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  <h3 className="font-semibold text-lg mb-3">Current System Stats</h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-3xl font-bold">{matchScores.length}</div>
                    ...
                    <div>
                      <div className="text-3xl font-bold">
                        {matchScores.length > 0
                          ? (matchScores.reduce((a, b) => a + b.score, 0) / matchScores.length * 100).toFixed(0)
                          : 0}%
                      </div>
                ...
                <div className="mt-6">
                  <h3 className="font-semibold text-lg mb-3">Algorithm Performance Analysis</h3>
                  <AlgorithmPerformance users={users} matchScores={matchScores} />
                </div>
              </CardContent>
            </Card>
          </TabsContent>
