...
export default function NetworkGraph({
    ...
    const simulation = d3
      ...
      .force(
        ...
        d3
          .forceLink(links)
          .id((d: any) => d.id)
          .distance(d => 150 * (1 - d.value))
      ) // Closer for higher scores
  ...
  return (
    <div className="relative">
      <svg ref={svgRef} className="w-full rounded border"></svg>
      <div className="absolute right-2 top-2 space-y-3 rounded bg-white p-3 text-xs shadow">
        <div>
          <div className="mb-1 font-semibold">
            Node Colors (Primary Interest):
          </div>
        ...
        <div>
          <div className="mb-1 font-semibold">Connection Strength:</div>
          <div className="space-y-1">
      ...
      <div className="mt-2 rounded bg-gray-50 p-3 text-sm">
        <p className="text-gray-600">
          <strong>Graph Insights:</strong> Nodes cluster naturally based on
          shared interests and compatibility scores. Thicker, greener lines
          indicate stronger matches based on multiple dimensions (interests,
          age, location). Users positioned closer together have more mutual
          connections. Click any node to highlight their network.
        </p>
      </div>
    </div>
  )
