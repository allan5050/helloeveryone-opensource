...
- [ ] This PR updates the database schema
- [ ] I have updated the TypeScript types to match database changes
- [ ] I have tested the migrations locally
...
- [ ] I have tested performance with realistic data
- [ ] I have optimized database queries
- [ ] N/A - No performance considerations
