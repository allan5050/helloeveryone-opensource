...
const communities = {
  ...
  creative: [
    {
      display_name: 'Allan',
      interests: ['indie-music', 'live-music', 'concerts', 'vinyl-records', 'photography', 'creative-writing'],
      location: '94110'
    },
    {
      display_name: 'Demo: Lisa Park',
      interests: ['photography', 'indie-music', 'concerts', 'film-photography', 'art-shows', 'creative-writing'],
      location: '94110'
    },
    {
      display_name: 'Demo: Patricia Lee',
      interests: ['painting', 'art-galleries', 'sketching', 'art-history', 'museums', 'poetry'],
      location: '94102'
    },
    {
      display_name: 'Demo: Emily Zhang',
      interests: ['indie-music', 'folk-music', 'writing', 'concerts', 'poetry', 'zines'],
      location: '94103'
    }
  ],
  ...
  tech: [
    {
      ...
      interests: ['sci-fi', 'star-wars', 'board-games', 'dungeons-dragons', 'comic-books', 'video-games'],
      location: '94107'
    },
    {
      display_name: 'Demo: Chris Thompson',
      interests: ['devops', 'home-automation', 'gaming', 'technology', 'robotics', 'hackathons'],
      location: '94107'
    },
    {
      display_name: 'Demo: Steven Clark',
      interests: ['blockchain', 'cryptocurrency', 'podcasts', 'astronomy', 'technology', 'futurism'],
      location: '94103'
    },
    {
      display_name: 'Demo: Daniel Harris',
      interests: ['qa-testing', 'automation', 'board-games', 'game-design', 'tabletop-rpg', 'puzzles'],
      location: '94102'
    }
  ],
  ...
  fitness: [
    {
      ...
      interests: ['triathlon', 'cycling', 'swimming', 'ironman', 'sports-medicine', 'fitness-tracking'],
      location: '94108'
    },
    {
      display_name: 'Demo: Nancy Wilson',
      interests: ['crossfit', 'nutrition', 'meal-prep', 'marathons', 'wellness-blogs', 'fitbit'],
      location: '94108'
    },
    {
      display_name: 'Demo: David Kim',
      interests: ['basketball', 'sports', 'coaching', 'fitness', 'sports-analytics', 'warriors'],
      location: '94107'
    },
    {
      display_name: 'Demo: Sarah Johnson',
      interests: ['running', 'hiking', 'trail-running', 'outdoor-fitness', 'marathons', 'strava'],
      location: '94110'
    }
  ],
  ...
  business: [
    {
      ...
      interests: ['golf', 'tennis', 'country-club', 'yacht-club', 'networking', 'finance'],
      location: '94108'
    },
    {
      display_name: 'Demo: Michael Brown',
      interests: ['marketing', 'ad-tech', 'golf', 'wine-tasting', 'business-strategy', 'investing'],
      location: '94102'
    },
    {
      display_name: 'Demo: Jennifer Davis',
      interests: ['product-management', 'fintech', 'venture-capital', 'startups', 'networking', 'ted-talks'],
      location: '94103'
    },
    {
      display_name: 'Demo: Maria Garcia',
      interests: ['entrepreneurship', 'healthtech', 'angel-investing', 'pitch-competitions', 'business-networking', 'forbes'],
      location: '94110'
    }
  ],
  ...
  food: [
    {
      ...
      interests: ['farmers-markets', 'organic-cooking', 'wine-tasting', 'cheese-making', 'slow-food', 'gardening'],
      location: '94102'
    },
    {
      display_name: 'Demo: Amanda White',
      interests: ['baking', 'cookbook-collecting', 'food-photography', 'restaurant-reviews', 'sourdough', 'pastry'],
      location: '94102'
    },
    {
      display_name: 'Demo: Jane Doe',
      interests: ['coffee-roasting', 'specialty-coffee', 'latte-art', 'cafe-culture', 'barista', 'coffee-cupping'],
      location: '94110'
    }
  ],
  ...
  science: [
    {
      ...
      interests: ['medical-research', 'biotech', 'scientific-journals', 'conferences', 'grant-writing', 'peer-review'],
      location: '94107'
    },
    {
      display_name: 'Demo: Sandra Young',
      interests: ['philosophy', 'classical-music', 'museums', 'lectures', 'npr', 'documentaries'],
      location: '94103'
    },
    {
      display_name: 'Demo: James Miller',
      interests: ['healthcare-tech', 'data-analysis', 'medical-devices', 'clinical-trials', 'research', 'pubmed'],
      location: '94108'
    }
  ],
  ...
  isolated: [
    {
      ...
      interests: ['zero-waste', 'veganism', 'climate-action', 'composting', 'sustainable-fashion', 'activism'],
      location: '94110'
    },
    {
      display_name: 'Demo: Kevin Martinez',
      interests: ['cybersecurity', 'privacy', 'chess', 'cryptography', 'infosec', 'defcon'],
      location: '94103'
    },
    {
      display_name: 'Demo: Paul Walker',
      interests: ['cars', 'diy', 'woodworking', 'mechanics', 'restoration', 'tools'],
      location: '94102'
    },
    {
      display_name: 'Demo: Alex Chen',
      interests: ['machine-learning', 'ai-research', 'kaggle', 'deep-learning', 'pytorch', 'arxiv'],
      location: '94107'
    }
  ]
};
    ...
    for (const member of members) {
      try {
        ...
        if (result && result.length > 0) {
          console.log(`✓ ${member.display_name}: ${member.interests.slice(0, 3).join(', ')}...`);
          successCount++;
        } else {
