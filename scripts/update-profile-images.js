...
async function updateProfileImages() {
  const profileImageMappings = [
    {
      user_id: 'a7984207-d812-47a1-8f13-ad39d7541649',
      image: '/images/emily_zhang.jpg',
      name: 'Emily Zhang',
    },
    {
      user_id: 'a2d67d17-8b7c-469b-91bc-2575ad58bc4a',
      image: '/images/michael_brown.jpg',
      name: 'Michael Brown',
    },
    {
      user_id: '3de4e2c9-af58-42bd-9f72-fe2675313ec1',
      image: '/images/lisa_park.jpg',
      name: 'Lisa Park',
    },
    {
      user_id: '3b22edec-c97d-4ac7-93b7-c49aa8e41001',
      image: '/images/tom_anderson.jpg',
      name: 'Tom Anderson',
    },
    {
      user_id: '6d43b482-db41-43b7-99ef-c02700e520b1',
      image: '/images/james_miller.jpg',
      name: 'James Miller',
    },
  ]
  ...
  const { data: profiles, error } = await supabase
    ...
    .in(
      'user_id',
      profileImageMappings.map(m => m.user_id)
    )
  ...
  if (profiles) {
    ...
    profiles.forEach(profile => {
      console.log(
        `  ${profile.display_name}: ${profile.photo_url || 'No image'}`
      )
    })
  }
}
